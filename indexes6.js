...
class Display{
   ...
   addToStorage(book) {
        ...
        if (nameText == null) {
            ...
            var nameArray = JSON.parse(nameText);
            var authorArray = JSON.parse(authorText);
            var typeArray = JSON.parse(typeText);
        }
    ...
    showMassage(type, massage, strongMassage) {

        let alertMassage = document.getElementById("alert");
        ...
        nameArray.forEach(function (element, index) {
            uiString += `
                    ...
                    <tr class="tableRow">
                        ...
                        <td><button  class="btn btn-light" onclick="display.deleteBook(${index})">Delete BooK</button></td>
                    </tr>
